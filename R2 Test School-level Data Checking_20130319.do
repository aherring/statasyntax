...
foreach var of varlist year-stem_out_other4 {
rename `var' `var'_AH
}

*Collapse data to school level.*
collapse year_AH-em_self_AH engage_fact_AH-stem_out_other4_AH, by(School_Short)
save "qualtricstestdata_school_cleanedv2"
...
foreach var of varlist enjoy-hardbest_none {
list School_Short `var' `var'_AH if `var' != `var'_AH, abbreviate(15)
}
...
foreach var of varlist gender-stem_out_online4 {
