...
use "qualtricstestdata_student.dta", clear
...
*Recode strength and weakness values.*
...
save "qualtricstestdata_student_cleaned"

*Prepare student-level data from SQL for checking after importing it into Stata.*
use "sqltestdata_student.dta", clear
rename ID responseid
sort responseid
duplicates report responseid
save "sqltestdata_student_cleaned.dta"

*Merge AH and MN datasets.*
use "qualtricstestdata_student_cleaned.dta", clear
merge 1:1 responseid using "sqltestdata_student_cleaned.dta", assert(match)
save "mergedtestdata_student.dta"
